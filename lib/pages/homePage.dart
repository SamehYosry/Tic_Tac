...
import 'package:tic_tac/pages/constants.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        elevation: 0,
        backgroundColor: Color.fromARGB(255, 183, 81, 81),
        actions: [
          IconButton(
      ...
      backgroundColor: Color.fromARGB(255, 38, 17, 17),
      body: Column(
        children: [
          _buildPointsTable(),
          _buildGrid(),
              ...
              child: Container(
                ...
                child: Center(
                  child: Text(
                    ...
                    style: TextStyle(
                      color:
                          _xOrOList[index] == 'x' ? Colors.white : Colors.amber,
                      fontSize: 40,
                    ),
                  ),
                ),
      ...
      child: Padding(
        ...
        child: Center(
          child: Text(
            ...
            style: customTextStyel(color: Colors.white),
          ),
        ),
      ),
    );
